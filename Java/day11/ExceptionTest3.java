...
public class ExceptionTest3 {
	...
	static void b() throws TestException { 
		// 예외가 발생할 상황이니 넘기겠다 라는 것을 알림 throws 
		// b()에서 발생하는지, 내부에서 호출되는 c() 함수에서 발생하는지
	...
	static void c() throws TestException {
		...
		boolean flag = new Random().nextBoolean(); // 불리언 타입의 변수 발생
		if(flag){
			throw new TestException("<<:::::테스트로 예외발생시킴:::::>>"); // 예외발생하면 더 이상 실행하지 않고 
		}else {
