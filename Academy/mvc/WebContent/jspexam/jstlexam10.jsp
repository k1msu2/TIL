...
<body>
<c:choose>
<!-- pageContext : jsp, EL 동시에 사용가능한 내장객체 -->
<!-- when 객체는 파싱할 xml과 관련이 없으므로 core lib 에서 가져옴 -->
	<c:when test="${ pageContext.request.method == 'GET' }">
		<h2>점검하려는 버스의 번호를 입력하세요</h2>
		<hr>
		<form method="POST" action="/mvc/jspexam/jstlexam10.jsp">
			버스번호 : <input type="nu	mber" name="num" min="0" required>
	...
	<c:otherwise>
	     ...
	     <hr>
		 <a href="/mvc/jspexam/jstlexam10.jsp">입력 화면으로</a>
	</c:otherwise>
</c:choose>
</body>
</html>
